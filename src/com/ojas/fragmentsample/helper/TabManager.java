		...
		.setOnClickListener((new OnClickListener() {
			...
			public void onClick(View v) {
				if (mTabHost.getCurrentTabTag().equals(finalTag)) {
					...
					altTabIndex = (finalTabIndex == 0) ? 1 : 0;
					/*
					 * Tab refresh hack. Meh. We could touch
					 * TabHost.mCurrentTab through reflection oreven
					 * extend TabHost, since TabHost.mCurrentTab
					 * isprotected, but both feel even hackier
					 * thanthis.
					 */
...
/*		if (CheckinLibraryActivity.isFromPop) {
			ft.setCustomAnimations(R.anim.slide_in_left,
					R.anim.slide_out_right);
			CheckinLibraryActivity.isFromPop = false;
		}*/
